...
export class DashboardService {
  ...
  getAdAccountWithSpend(companyId: any, timeRange: any): Observable<any> {
    return this.http.get<any>(`${this.apiUrl}/auth/facebook/adaccounts/spend/${companyId}?since=${timeRange.since}&until=${timeRange.until}`);
  }
